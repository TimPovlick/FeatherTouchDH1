...
; Generated by Tim Povlick on 3/16/2021 (UTC)
;
[Setup]
AppID={{517a13ea-35f9-4f66-9ed7-8b450be376ea}
AppName=ASCOM FeatherTouchDH1 Focuser Driver
AppVerName=ASCOM FeatherTouchDH1 Focuser Driver 5.0.1
AppVersion=5.0.1
AppPublisher=Tim Povick <apochromat@gmail.com>
AppPublisherURL=mailto:apochromat@gmail.com
...
OutputDir="."
OutputBaseFilename="FeatherTouchDH1Setup"
Compression=lzma
...
UninstallFilesDir="{commoncf}\ASCOM\Uninstall\Focuser\FeatherTouchDH1"
...
[Dirs]
Name: "{commoncf}\ASCOM\Uninstall\Focuser\FeatherTouchDH1"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

;  Add an option to install the source files
; TPP [Tasks]
; TPP Name: source; Description: Install the Source files; Flags: unchecked

[Files]
Source: "Release\x86\ASCOM.FeatherTouchDH1.Focuser.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
; Optional source files (COM and .NET aware)
; Source: ".\*"; Excludes: *.zip,*.exe,*.dll, \bin\*, \obj\*; DestDir: "{app}\Source\FeatherTouchDH1 Driver"; Tasks: source; Flags: recursesubdirs
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.FeatherTouchDH1.Focuser.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.FeatherTouchDH1.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.FeatherTouchDH1.Focuser.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.FeatherTouchDH1.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.FeatherTouchDH1.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
